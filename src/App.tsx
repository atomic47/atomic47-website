        ...
        <div className="body">
          <Switch>
            <Route exact path="/">
              ...
              <div className="simple-text" id="What-We-Do">
                <h1>What We Do</h1>
                <h2>
              ...
              <ThreePartSection
                type="right"
                headerText="Product Design & Development"
                ...
                bulletPoints={["UI/UX Design", "Product Design", "Software Development", "Security & Infrastructure", "Product Management"]}
              />
              {/* <ThreePartSection
                type="left"
              ...
              <ThreePartSection
                ...
                bulletPoints={["Advertising", "Marketing Strategy", "Copywriting", "Public Relations"]}
              />
              <BrandSection />
            </Route>
            <Route path="/blog">
